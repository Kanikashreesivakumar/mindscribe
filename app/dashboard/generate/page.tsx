  ...
  return (
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <h1 className="text-3xl font-bold text-white mb-2">Image-to-Text</h1>
        <p className="text-gray-400">Convert neural network diagrams into detailed text descriptions using our AI</p>
      </motion.div>

      <Tabs defaultValue="generate" className="w-full">
        <TabsList className="grid w-full grid-cols-2 bg-gray-900 border border-gray-800">
          <TabsTrigger value="generate" className="data-[state=active]:bg-cyberpunk-neon-purple/20">
            Generate
          </TabsTrigger>
            ...
            <CardContent className="p-6">
              <div className="mb-4 flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-medium text-white">Image-to-Text Processor</h3>
                </div>
                {isProcessing && (
                  <div className="flex items-center">
                    <div className="mr-2 h-2 w-2 rounded-full bg-cyberpunk-neon-purple animate-pulse"></div>
                    <span className="text-sm text-cyberpunk-neon-purple">Processing image...</span>
                  </div>
                )}
              </div>
                    ...
                    {previewUrl ? (
                      <div className="relative w-full h-full flex items-center justify-center">
                        <img
                          ...
                          alt="Selected neural network diagram"
                      ...
                      <>
                        ...
                        <p className="text-gray-400 text-center mb-2">Drag & drop a neural network diagram here</p>
            ...
            <CardContent className="p-6">
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-400">
                  Refine and edit the text generated from your neural network diagram
                </p>
              </div>
              ...
              <Textarea
                value={generatedText}
                onChange={(e) => setText(e.target.value)}
                placeholder="No text to edit yet. Start a generation session first."
